...
namespace ImageManager.Tools
{
    ...
    public static class ClipboardHelper
    {
        ...
        {
            const string sContextStart = "<HTML>\r\n<body>\r\n<!--StartFragment-->";
            int sContextStartLength = sContextStart.Length;
            const string sContextEnd = "<!--EndFragment-->\r\n</body>\r\n</HTML>";
            int sContextEndLength = sContextEnd.Length;
            const string sDescription = "Version:0.9\r\nStartHTML:aaaaaaaaaa\r\nEndHTML:bbbbbbbbbb\r\nStartFragment:cccccccccc\r\nEndFragment:dddddddddd\r\nSourceURL:\r\n";
            int sDescriptionLength = sDescription.Length;
            ...
            sData = sData.Replace("dddddddddd", (sDescriptionLength + sContextStartLength + htmlLength).ToString("D9"));
            return sData;
        }
